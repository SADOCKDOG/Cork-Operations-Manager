...
const App = {
    ...
    async renderAjustes() {
        ...
        main.innerHTML = `
            ...
            <div class="card text-center" style="border-top: 2px solid var(--p-cork); margin-top:30px; padding:30px;"><img src="icons/logo-header.png" style="width:140px; margin-bottom:20px;"><p style="font-weight:800; color:var(--p-cork);">Chamorro´s Cork Manager v6.2.9</p></div>`;
    },
