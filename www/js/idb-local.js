...
(function(e) {
    ...
    function d(e) {
        return "function" == typeof e ? u(e) : (e instanceof IDBTransaction && function(e) {
            ...
            o.set(e, t)
        }(e), t(e, n || (n = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(e, a) : e)
    }
    ...
    function y(e, t) {
        ...
        const n = t.replace(/FromIndex$/, ""),
            r = t !== n,
            o = D.includes(n);
        if (!(n in (r ? IDBIndex : IDBObjectStore).prototype) || !o && !p.includes(n)) return;
        const s = async function(e, ...t) {
            const s = this.transaction(e, o ? "readwrite" : "readonly");
            let i = s.store;
            return r && (i = i.index(t.shift())), (await Promise.all([i[n](...t), o && s.done]))[0]
        };
        return I.set(t, s), s
    }
    c((e => ({ ...e,
    ...
    async function* m(...e) {
        ...
        for (v.set(n, t), i.set(n, l(t)); t;) yield n, t = await (g.get(n) || t.continue()), g.delete(n)
    }
    ...
    c((e => ({ ...e,
        ...
        })), n && i.addEventListener("blocked", (e => n(e.oldVersion, e.newVersion, e))), a.then((e => {
            s && e.addEventListener("close", (() => s())), o && e.addEventListener("versionchange", (e => o(e.oldVersion, e.newVersion, e)))
        })).catch((() => {})), a
    }, e.unwrap = l, e.wrap = f
})(idb_exports);

export const { openDB, deleteDB, unwrap, wrap } = idb_exports;
